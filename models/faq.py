...
FAQ_ITEMS = [
    ...
    {
        "q": "Comment fonctionne le panier recette ou coffret ?",
        "a": "Sur les pages Recettes ou Coffrets, le bouton « Ajouter tout au panier » place automatiquement tous les ingrédients ou produits du bundle dans votre panier.",
    },
    {
        "q": "Quels modes de paiement acceptez-vous ?",
        "a": "Carte bancaire (Stripe si activé), PayPal, virement bancaire, espèces à la livraison et mobile money (Wave, Orange Money, MTN) sur demande.",
    },
    {
        "q": "Comment suivre ma commande ?",
        "a": "Après validation, vous recevez un e-mail de confirmation. Utilisez la page Suivi de commande avec votre numéro de commande et l'e-mail indiqué lors de l'achat.",
    },
    {
        "q": "Livrez-vous à domicile ?",
        "a": "Oui, selon votre commune. Indiquez une adresse complète au checkout ; nous vous confirmons les modalités par message ou e-mail.",
    },
    {
    ...
    },
    {
        ...
        "a": "Oui. Choisissez un coffret diaspora, ajoutez-le au panier et précisez un message cadeau dans les instructions livreur à l'étape commande.",
    },
    {
