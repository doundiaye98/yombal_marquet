...
LABELAFRIK_ALIMENTS = [
    ...
    _lf("UD-POISS-F", "poisson-fume-ud", "Poisson fumé", "Séché et fumé — soupes, sauces, thiéb.", CATEGORY_CONSERVES, "🐟", 18, "500 g"),
    _lf("UD-BARBET", "rouge-barbet-ud", "Rouge barbet", "Poisson frais — friture ou grillade.", CATEGORY_ALIMENTAIRE, "🐟", 7.5, "1 kg"),
]
