(function () {
  ...
  function sendQuestion(question) {
    ...
    fetch((root.getAttribute("data-api-url") || "/api/assistant"), {
      method: "POST",
        ...
        if (data.hint === "order_tracking") {
          addMessage(
            ...
            formatBotHtml(answer) +
              '<div class="assistant-cta"><a href="' +
              (root.getAttribute("data-suivi-url") || "/suivi-commande") +
              '">Accéder au suivi de commande</a></div>'
          );
