<div class="page-wrapper apropos-page">
  <header class="page-hero page-hero--editorial">
    ...
    <div class="page-hero-content">
      <p class="section-eyebrow reveal">Groupe YOMBAL</p>
      <h1 class="section-title reveal">Yombal <em>Marché</em></h1>
      <p class="section-sub reveal page-hero-lead">
        Un écosystème complet au service de ceux qui veulent consommer utile,
        authentique et accessible — ici comme là-bas.
      </p>
      <ul class="apropos-hero-points reveal" aria-label="En bref">
        <li><span aria-hidden="true">🛒</span> Boutique en ligne &amp; livraison</li>
        <li><span aria-hidden="true">✈️</span> Voyages, immobilier &amp; transports</li>
        <li><span aria-hidden="true">🤝</span> Confiance, clarté, proximité</li>
      </ul>
    </div>
  </header>
  ...
  <section class="section section--flush-top apropos-story reveal" aria-labelledby="apropos-histoire">
    <div class="apropos-story__inner">
      ...
      <h2 id="apropos-histoire" class="section-title">Le goût du vrai, <em>la force d'un groupe</em></h2>
      <div class="apropos-story__grid">
        <div class="apropos-story__main">
          <p class="apropos-p apropos-p--lead">
            Le Groupe YOMBAL est né d'une conviction simple&nbsp;: offrir à la diaspora
            et aux familles un accès direct, fiable et structuré aux produits et services
            qui comptent au quotidien.
          </p>
          <p class="apropos-p">
            Avec <strong>Yombal Marché</strong>, notre boutique en ligne, nous sélectionnons
            avec exigence des produits alimentaires authentiques — riz, céréales, épices,
            huiles, boissons, produits de la mer —, des cosmétiques naturels, de l'électronique
            et des coffrets cadeaux pensés pour faire plaisir.
            Chaque référence est choisie pour sa qualité, sa traçabilité et sa pertinence,
            et présentée avec une transparence totale&nbsp;: origine, composition, allergènes,
            conseils d'utilisation et prix TTC.
          </p>
          <p class="apropos-p">
            Mais le Groupe YOMBAL va bien au-delà de la boutique.
          </p>
          <p class="apropos-p">
            <strong>Yombal Voyages</strong> organise vos départs vers le Sénégal, l'Afrique
            et le monde entier&nbsp;: vols, séjours, circuits et croisières.<br>
            <strong>Yombal Immobilier &amp; BTP</strong> accompagne la diaspora&nbsp;: terrains
            à céder avec paiement échelonné, construction, rénovation et suivi de chantier.<br>
            <strong>Yombal Transports</strong> couvre véhicules, location, déménagement et colis.<br>
            <strong>Yombal Restaurant</strong>, <strong>Yombal Coiffure</strong>,
            <strong>électronique</strong>, <strong>électroménager</strong>, <strong>mode</strong>,
            <strong>chaussures</strong> et <strong>bagagerie</strong> complètent l'écosystème.
          </p>
          <p class="apropos-p">
            Chaque activité repose sur les mêmes engagements&nbsp;: sélection rigoureuse,
            information claire, accompagnement humain et livraison suivie.
          </p>
        </div>
        <blockquote class="apropos-pullquote">
          <p>«&nbsp;Le Groupe YOMBAL, c'est un écosystème complet au service de ceux qui veulent
          consommer utile, authentique et accessible — ici comme là-bas.&nbsp;»</p>
  ...
  <section class="section section--compact section--alt" aria-labelledby="apropos-mission">
    <div class="apropos-section-head reveal">
      ...
      <h2 id="apropos-mission" class="section-title">Quatre engagements <em>au quotidien</em></h2>
    ...
    <div class="apropos-pillars apropos-pillars--4 reveal" aria-label="Nos engagements">
      <article class="apropos-pillar">
        <span class="apropos-pillar__icon" aria-hidden="true">🌿</span>
        <h3>Sélection rigoureuse</h3>
        <p>Une gamme structurée autour du terroir africain et de l'épicerie fine, conforme à une charte qualitative définie par l'enseigne.</p>
      </article>
      <article class="apropos-pillar">
        <span class="apropos-pillar__icon" aria-hidden="true">🧾</span>
        <h3>Information normalisée</h3>
        <p>Des fiches produits homogènes&nbsp;: origine, ingrédients, allergènes et conservation, pour un choix d'achat documenté et sécurisé.</p>
      </article>
      <article class="apropos-pillar">
        <span class="apropos-pillar__icon" aria-hidden="true">🤝</span>
        <h3>Service client réactif</h3>
        <p>Commande avec ou sans compte, paiement sécurisé, suivi de commande par e-mail et prise en charge sous 24&nbsp;h ouvrées.</p>
      </article>
      <article class="apropos-pillar">
        <span class="apropos-pillar__icon" aria-hidden="true">🌍</span>
        <h3>Écosystème complet</h3>
        <p>Au-delà de la boutique&nbsp;: voyages, immobilier, transports, restauration et services — un groupe entier à votre service.</p>
      </article>
    </div>
  </section>
  ...
  <section class="section section--compact" aria-labelledby="apropos-offre">
    <div class="apropos-grid">
      <div class="reveal">
        ...
        <p class="apropos-p">
          Découvrez aussi les <a href="<?= e(url('/recettes')) ?>">recettes avec panier intelligent</a>,
          la <a href="<?= e(url('/saveurs')) ?>">carte des saveurs</a>, les
          <a href="<?= e(url('/coffrets')) ?>">coffrets cadeaux</a> et
          <a href="<?= e(url('/ecosysteme')) ?>">l'Univers YOMBAL</a>.
        </p>
        ...
        <div class="apropos-yombal-band reveal">
          ...
          <p class="apropos-yombal-band__text">
            ...
            transports, électronique, restauration, coiffure et autres services.
            Une même exigence de qualité, au service de vos projets du quotidien comme de vos envies d'ailleurs.
          </p>
          <p class="apropos-yombal-band__cta">
            <a href="<?= e(url('/ecosysteme')) ?>" class="btn-outline">Explorer Univers YOMBAL</a>
          </p>
        </div>
      </div>
      ...
      <aside class="aside-box reveal" aria-label="Résumé de l'offre">
        ...
        <a href="<?= e(url('/contact')) ?>" class="btn-outline aside-cta" style="margin-top:10px;display:inline-flex;">Contact &amp; paiement</a>
  ...
  <section class="section section--compact section--alt" aria-labelledby="apropos-confiance">
    <div class="apropos-section-head reveal">
      ...
      <p class="section-sub section-sub--tight">Parce qu'acheter en ligne doit rester simple, lisible et rassurant.</p>
    </div>
